...
private class AndroidSoterClient(
    ...
    override fun isSupportFingerprint(): Boolean = SoterCore.isSupportFingerprint(appContext)

    override fun isSystemHasFingerprint(): Boolean = SoterCore.isSystemHasFingerprint(appContext)
